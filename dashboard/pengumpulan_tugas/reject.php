<?php
// dashboard/submissions/reject.php
session_start();
...
mysqli_query($koneksi, "UPDATE assignment_submissions SET status = 'rejected' WHERE id = $id");
$_SESSION['success_message'] = "Tugas berhasil ditolak.";
header("Location: index.php");
exit();
